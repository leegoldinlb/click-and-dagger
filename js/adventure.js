...
const Adventure = (() => {
  ...
  function lookEnt(e) {
    ...
    switch (e.kind) {
      ...
      // --- theme park set ---
      case 'parkcastle': return 'A fairytale castle in blue and gold, built at about two-thirds the size your eye insists it is. Every sightline in the park bends toward it, which is the entire point of it.';
      // --- paris opera set ---
      case 'parisphantom':
