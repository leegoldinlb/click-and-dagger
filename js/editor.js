...
const Editor = (() => {
  ...
  const ENTS = [
    ...
    { kind: 'parisoperabust1', name: 'MARBLE BUST', spr: 'parisoperabust1' },
    { kind: 'parisoperabust2', name: 'MARBLE BUST', spr: 'parisoperabust2' },
    { kind: 'parisoperamusicstand', name: 'MUSIC STAND', spr: 'parisoperamusicstand' },
    { kind: 'parisoperadrape', name: 'DRAPED MARBLE', spr: 'parisoperadrape' },
    { kind: 'parisoperaapollo', name: 'STATUE OF APOLLO', spr: 'parisoperaapollo' },
    { kind: 'parisoperachair', name: 'VELVET ARMCHAIR', spr: 'parisoperachair' },
    { kind: 'parisoperaharp', name: 'GILDED HARP', spr: 'parisoperaharp' },
    { kind: 'parisoperaceiling', name: 'CEILING FRESCO', spr: 'parisoperaceiling' },
    { kind: 'parisoperasign', name: 'LOGE 1 ORCHESTRE SIGN', spr: 'parisoperasign' },
    { kind: 'parisoperarigging', name: 'FLY RIGGING', spr: 'parisoperarigging' },
    { kind: 'parisoperaprogramstand', name: 'PROGRAM STAND', spr: 'parisoperaprogramstand' },
    { kind: 'parisoperastatuegroup', name: 'ALLEGORICAL STATUE', spr: 'parisoperastatuegroup' },
    { kind: 'parisoperatapestry', name: 'GARDEN TAPESTRY', spr: 'parisoperatapestry' },
    { kind: 'parisoperamannequin', name: 'DRESS FORM', spr: 'parisoperamannequin' },
    { kind: 'parisoperasconce', name: 'CANDLE SCONCE', spr: 'parisoperasconce' },
    { kind: 'parisoperafan', name: 'PAINTED FAN', spr: 'parisoperafan' },
    { kind: 'parisoperadoor', name: 'LOGE DOOR', spr: 'parisoperadoor' },
    { kind: 'parisoperaclock', name: 'MANTEL CLOCK', spr: 'parisoperaclock' },
    { kind: 'parisoperascorestand', name: 'SHEET MUSIC STAND', spr: 'parisoperascorestand' },
    { kind: 'parisoperapanel', name: 'GILDED INSTRUMENT PANEL', spr: 'parisoperapanel' },
    { kind: 'parisoperatrunk', name: 'STAGE TRUNK', spr: 'parisoperatrunk' },
    { kind: 'parisoperaseatrow', name: 'THEATER SEAT ROW', spr: 'parisoperaseatrow' },
    // --- sci-fi set ---
    ...
    { kind: 'oaktree', name: 'OAK TREE', spr: 'oaktree' },
    { kind: 'pinetree', name: 'PINE TREE', spr: 'pinetree' },
    { kind: 'mapletree', name: 'MAPLE TREE', spr: 'mapletree' },
    { kind: 'birchtree', name: 'BIRCH TREE', spr: 'birchtree' },
    ...
    { kind: 'havanarumbillboard', name: 'HAVANA CLUB RUM BILLBOARD', spr: 'havanarumbillboard' },
    { kind: 'havanafloriditasign', name: 'EL FLORIDITA', spr: 'havanafloriditasign' },
    { kind: 'havanateatrosign', name: 'TEATRO PAYRET', spr: 'havanateatrosign' },
    { kind: 'havanaaviacionposter', name: 'CUBANA DE AVIACION POSTER', spr: 'havanaaviacionposter' },
    { kind: 'havanaministeriosign', name: 'MINISTERIO DEL INTERIOR', spr: 'havanaministeriosign' },
    { kind: 'havanacafemenu', name: 'CAFE DE LA HABANA MENU', spr: 'havanacafemenu' },
    { kind: 'havanastreetpost', name: 'CALLE OBISPO STREET POST', spr: 'havanastreetpost' },
    { kind: 'havanacafeteriasign', name: 'CAFETERIA LA BODEGUITA', spr: 'havanacafeteriasign' },
    { kind: 'havanaazucarbillboard', name: 'OPERACION AZUCAR BILLBOARD', spr: 'havanaazucarbillboard' },
    { kind: 'havanaphonesign', name: 'TELEPHONE SIGN', spr: 'havanaphonesign' },
    { kind: 'nycbillboard', name: 'SILVERSTREAK CIGARETTES BILLBOARD', spr: 'nycbillboard' },
    { kind: 'nycjazzsign', name: 'THE BLUE NOTE JAZZ CLUB', spr: 'nycjazzsign' },
    { kind: 'nyccabaretsign', name: 'BROADWAY CABARET', spr: 'nyccabaretsign' },
    { kind: 'nycpanamposter', name: 'PAN AM POSTER', spr: 'nycpanamposter' },
    { kind: 'nycsubwaysign', name: 'N.Y.C. SUBWAY SIGN', spr: 'nycsubwaysign' },
    { kind: 'nyccafesign', name: "JOE'S ALL-NIGHT CAFE", spr: 'nyccafesign' },
    { kind: 'nycstreetpost', name: '5TH AVE STREET POST', spr: 'nycstreetpost' },
    { kind: 'nycelectronicssign', name: 'MODERN ELECTRONICS SIGN', spr: 'nycelectronicssign' },
    { kind: 'nycmoscowbillboard', name: 'THE MAN FROM MOSCOW BILLBOARD', spr: 'nycmoscowbillboard' },
    { kind: 'nycpostsign', name: 'NEW YORK POST SIGN', spr: 'nycpostsign' },
    { kind: 'nycphonesign', name: 'TELEPHONE SIGN', spr: 'nycphonesign' },
    { kind: 'nycparkingsign', name: 'NO PARKING SIGN', spr: 'nycparkingsign' },
    { kind: 'pariscafesign', name: 'CAFE DES DEUX MAGOTS', spr: 'pariscafesign' },
    { kind: 'parisposter1', name: 'MISSION CASABLANCA POSTER', spr: 'parisposter1' },
    { kind: 'matrongirlpearl', name: 'GIRL WITH A PEARL EARRING', spr: 'matrongirlpearl' },
    { kind: 'matronlastsupper', name: 'THE LAST SUPPER', spr: 'matronlastsupper' },
    { kind: 'matronfrida', name: 'SELF-PORTRAIT WITH MONKEYS', spr: 'matronfrida' },
    { kind: 'matrongothic', name: 'AMERICAN GOTHIC', spr: 'matrongothic' },
    { kind: 'matronmagritte', name: 'THE SON OF MAN', spr: 'matronmagritte' },
    { kind: 'matronscream', name: 'THE SCREAM', spr: 'matronscream' },
    { kind: 'matronmonalisa', name: 'MONA LISA', spr: 'matronmonalisa' },
    { kind: 'parisposter2', name: 'LA DERNIERE VAGUE POSTER', spr: 'parisposter2' },
    { kind: 'parisruesign', name: 'RUE DES RENAISSANCES', spr: 'parisruesign' },
    { kind: 'parisbrasseriesign', name: "BRASSERIE DE L'OPERA", spr: 'parisbrasseriesign' },
    { kind: 'parisposter3', name: 'VINS NICOLAS POSTER', spr: 'parisposter3' },
    { kind: 'parisodeonsign', name: 'STATION ODEON SIGN', spr: 'parisodeonsign' },
    { kind: 'parislibrairiesign', name: 'LIBRAIRIE ANCIENNE', spr: 'parislibrairiesign' },
    { kind: 'parisstreetcorner', name: 'RUE + INTERDIT STATIONNER CORNER', spr: 'parisstreetcorner' },
    { kind: 'parisboulangeriesign1', name: 'BOULANGERIE LE BON PAIN (DARK)', spr: 'parisboulangeriesign1' },
    { kind: 'parisboulangeriesign2', name: 'BOULANGERIE LE BON PAIN (LIGHT)', spr: 'parisboulangeriesign2' },
    { kind: 'parisbusstopsign', name: 'ARRET BUS SIGN', spr: 'parisbusstopsign' },
    { kind: 'hkcatheaybillboard', name: 'FLY CATHEAY PACIFIC BILLBOARD', spr: 'hkcatheaybillboard' },
    { kind: 'hkpagodabillboard', name: 'GOLDEN PAGODA BEER BILLBOARD', spr: 'hkpagodabillboard' },
    { kind: 'hktheatresign', name: 'WORLD THEATRE SIGN', spr: 'hktheatresign' },
    { kind: 'hkjockeyclubsign', name: 'HONG KONG JOCKEY CLUB SIGN', spr: 'hkjockeyclubsign' },
    { kind: 'hkromanceposter', name: 'A CLASSIC ROMANCE POSTER', spr: 'hkromanceposter' },
    { kind: 'hkshaolinposter', name: 'SHAOLIN TEMPLE ART EXHIBIT POSTER', spr: 'hkshaolinposter' },
    { kind: 'hkbirdcages', name: 'HANGING BIRD CAGES', spr: 'hkbirdcages' },
    { kind: 'hkredanchorsign', name: 'RED ANCHOR CIGARETTES SIGN', spr: 'hkredanchorsign' },
    { kind: 'hkstreetpost', name: 'NATHAN RD STREET POST', spr: 'hkstreetpost' },
    { kind: 'hkstopsign', name: 'STOP SIGN', spr: 'hkstopsign' },
    { kind: 'hkhsbcsign', name: 'HSBC HONG KONG BRANCH SIGN', spr: 'hkhsbcsign' },
    { kind: 'hkqueensroadsign', name: "QUEEN'S ROAD CENTRAL SIGN", spr: 'hkqueensroadsign' },
    { kind: 'hkrickshaw', name: 'RICKSHAW', spr: 'hkrickshaw' },
    { kind: 'hkricemerchantsign', name: 'RICE MERCHANT SIGN', spr: 'hkricemerchantsign' },
    { kind: 'hkferry', name: 'STAR FERRY', spr: 'hkferry' },
    { kind: 'hkdragondensign', name: 'DRAGON DEN BAR & NIGHTCLUB SIGN', spr: 'hkdragondensign' },
    { kind: 'hknightmarketsign', name: 'NIGHT MARKET SIGN', spr: 'hknightmarketsign' },
    { kind: 'hkphonesign', name: 'TELEPHONE SIGN', spr: 'hkphonesign' },
    { kind: 'tehranstreetsign1', name: 'KHIYABAN PAHLAVI SIGN', spr: 'tehranstreetsign1' },
    { kind: 'tehranshadowposter', name: 'OPERATION SHADOW POSTER', spr: 'tehranshadowposter' },
    { kind: 'tehranganjeposter', name: 'GANJ-E QAROON POSTER', spr: 'tehranganjeposter' },
    { kind: 'tehranbooksign1', name: 'KITABFOROOSHI SIGN (1)', spr: 'tehranbooksign1' },
    { kind: 'tehrancafesign', name: 'CAFE NADERI SIGN', spr: 'tehrancafesign' },
    { kind: 'tehranteaposter', name: 'CHAI POSTER', spr: 'tehranteaposter' },
    { kind: 'tehranstreetsign2', name: 'MEYDAN-E AZADI SIGN (1)', spr: 'tehranstreetsign2' },
    { kind: 'tehrancinemasign', name: 'CINEMA MOULIN ROUGE SIGN', spr: 'tehrancinemasign' },
    { kind: 'tehranbooksign2', name: 'KITABFOROOSHI SIGN (2)', spr: 'tehranbooksign2' },
    { kind: 'tehranstreetsign3', name: 'MEYDAN-E AZADI SIGN (2)', spr: 'tehranstreetsign3' },
    ...
    { kind: 'doorbluepaneled', name: 'BLUE PANELED DOOR', spr: 'doorbluepaneled' },
    { kind: 'doornavyornate', name: 'NAVY ORNATE DOOR', spr: 'doornavyornate' },
    { kind: 'doorbrowntransom1', name: 'BROWNSTONE DOOR (1)', spr: 'doorbrowntransom1' },
    { kind: 'doornavyarched', name: 'NAVY ARCHED DOOR', spr: 'doornavyarched' },
    { kind: 'doorblackplain', name: 'BLACK PANELED DOOR', spr: 'doorblackplain' },
    { kind: 'doorsaloon', name: 'SALOON DOORS', spr: 'doorsaloon' },
    { kind: 'doorbankelevator', name: 'BANK ELEVATOR DOOR', spr: 'doorbankelevator' },
    { kind: 'doorhavanashutter', name: 'WEATHERED SHUTTER DOOR', spr: 'doorhavanashutter' },
    { kind: 'doorbrowntransom2', name: 'BROWNSTONE DOOR (2)', spr: 'doorbrowntransom2' },
    { kind: 'doorbrowntransom3', name: 'BROWNSTONE DOOR (3)', spr: 'doorbrowntransom3' },
    { kind: 'doorbrowntransom4', name: 'BROWNSTONE DOOR (4)', spr: 'doorbrowntransom4' },
    { kind: 'doormoscoweagle', name: 'STONE EAGLE ENTRY DOOR', spr: 'doormoscoweagle' },
    { kind: 'doorsecuritygray', name: 'GRAY SECURITY DOOR', spr: 'doorsecuritygray' },
    { kind: 'doorlondon10', name: 'LONDON NO. 10 DOOR', spr: 'doorlondon10' },
    { kind: 'doordiamondglass', name: 'DIAMOND-GLASS DOOR', spr: 'doordiamondglass' },
    { kind: 'londonrow', name: 'LONDON TERRACED ROW', spr: 'londonrow' },
    { kind: 'londonoffice', name: 'LONDON OFFICE BUILDING', spr: 'londonoffice' },
    { kind: 'londonflats', name: 'LONDON APARTMENT BLOCK', spr: 'londonflats' },
    { kind: 'hkcluster', name: 'HONG KONG TENEMENT CLUSTER', spr: 'hkcluster' },
    { kind: 'hkdomebuilding', name: 'HONG KONG DOME CORNER BUILDING', spr: 'hkdomebuilding' },
    { kind: 'parisrow1', name: 'PARIS HAUSSMANN ROW (1)', spr: 'parisrow1' },
    { kind: 'parisrow2', name: 'PARIS HAUSSMANN ROW (2)', spr: 'parisrow2' },
    { kind: 'moscowblock', name: 'MOSCOW APARTMENT BLOCK', spr: 'moscowblock' },
    { kind: 'havanarow', name: 'HAVANA COLONIAL ROW', spr: 'havanarow' },
    { kind: 'tehranmosquebuilding', name: 'TEHRAN TILED BUILDING', spr: 'tehranmosquebuilding' },
    { kind: 'tehranoffice', name: 'TEHRAN OFFICE TOWER', spr: 'tehranoffice' },
    ...
    { kind: 'cathedral', name: 'HAVANA CATHEDRAL', spr: 'cathedral' },
    { kind: 'capitolio', name: 'EL CAPITOLIO', spr: 'capitolio' },
    { kind: 'fort', name: 'EL MORRO', spr: 'fort' },
    ...
    { kind: 'skull', name: 'SKULL', spr: 'skull' },
    { kind: 'skullpile', name: 'PILE OF SKULLS', spr: 'skullpile' },
    { kind: 'operaplans', name: 'PLANS DE L’OPÉRA', spr: 'operaplans' },
    { kind: 'catacombssign', name: 'CATACOMBES DE PARIS SIGN', spr: 'catacombssign' },
    { kind: 'dallasnews', name: 'THE DALLAS MORNING NEWS', spr: 'dallasnews' },
    ...
    { kind: 'empirestate', name: 'EMPIRE STATE BUILDING', spr: 'empirestate' },
    { kind: 'chryslerbuilding', name: 'CHRYSLER BUILDING', spr: 'chryslerbuilding' },
    { kind: 'unbuilding', name: 'U.N. HEADQUARTERS', spr: 'unbuilding' },
    { kind: 'firehouse', name: 'FIREHOUSE', spr: 'firehouse' },
  ...
  function fromLevel(json) {
    ...
    geo.sectors = (json.geo && json.geo.sectors) ? json.geo.sectors.map(s => ({
      ...
      wallOpen: s.wallOpen ? s.wallOpen.slice() : null,
    ...
    if (geo.sectors.length) {
      out.geo = {
        ...
        sectors: geo.sectors.map(s => ({ loop: s.loop.slice(), floor: s.floor, ceil: s.ceil, floorTex: s.floorTex, ceilTex: s.ceilTex, sky: !!s.sky, skyTex: s.skyTex || undefined, win: !!s.win, hostile: !!s.hostile, texScale: s.texScale || 1,
          ...
          wallOpen: (s.wallOpen && s.wallOpen.some(Boolean)) ? s.wallOpen.slice() : undefined,
  ...
  // Build/Doom convention: a sub-sector's edges are SOLID walls by default —
  // like Build's plain white walls — not automatic openings into the parent.
  ...
  function geoOpenWall() {
    const hit = pickGeoWall(); if (!hit) { status('LOOK AT A WALL.'); return; }
    const sec = geo.sectors[hit.s];
    if (sec.parent < 0) { status('WALL ' + (hit.i + 1) + ' — not a sub-sector edge, always solid on its own.'); return; }
    if (!sec.wallOpen) sec.wallOpen = new Array(sec.loop.length).fill(false);
    const next = !sec.wallOpen[hit.i];
    sec.wallOpen[hit.i] = next;
    portalGraph = Engine.buildGraph(geo);                     // re-derive wall.next for this edge
    status('WALL ' + (hit.i + 1) + ' SUB-SECTOR BOUNDARY → ' + (next ? 'OPEN (joined to parent)' : 'SOLID (real wall again)'));
  }
  ...
  window.addEventListener('keydown', e => {
    ...
    if (!previewCompiled) {
      ...
      if (e.code === 'KeyI') { if (!e.repeat) pushUndo(); if (sh) geoOpenWall(); else geoBlockWall(); e.preventDefault(); return; }   // I: invisible wall (open portal, blocked movement) · Shift+I: join a sub-sector edge through to its parent
