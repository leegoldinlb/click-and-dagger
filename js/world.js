...
const World = (() => {
  ...
  SPR.havanateatrosign = SPR.desk;
  SPR.havanaaviacionposter = SPR.desk;
  SPR.havanaministeriosign = SPR.desk;
  SPR.havanacafemenu = SPR.desk;
  SPR.havanastreetpost = SPR.desk;
  SPR.havanacafeteriasign = SPR.desk;
  SPR.havanaazucarbillboard = SPR.desk;
  SPR.havanaphonesign = SPR.desk;
  SPR.nycbillboard = SPR.desk;
  SPR.nycjazzsign = SPR.desk;
  SPR.nyccabaretsign = SPR.desk;
  SPR.nycpanamposter = SPR.desk;
  SPR.nycsubwaysign = SPR.desk;
  SPR.nyccafesign = SPR.desk;
  SPR.nycstreetpost = SPR.desk;
  SPR.nycelectronicssign = SPR.desk;
  SPR.nycmoscowbillboard = SPR.desk;
  SPR.nycpostsign = SPR.desk;
  SPR.nycphonesign = SPR.desk;
  ...
  SPR.parisposter3 = SPR.desk;
  SPR.parisodeonsign = SPR.desk;
  SPR.parislibrairiesign = SPR.desk;
  SPR.parisstreetcorner = SPR.desk;
  SPR.parisboulangeriesign1 = SPR.desk;
  SPR.parisboulangeriesign2 = SPR.desk;
  SPR.parisbusstopsign = SPR.desk;
  SPR.hkcatheaybillboard = SPR.desk;
  SPR.hkpagodabillboard = SPR.desk;
  SPR.hktheatresign = SPR.desk;
  SPR.hkjockeyclubsign = SPR.desk;
  SPR.hkromanceposter = SPR.desk;
  SPR.hkshaolinposter = SPR.desk;
  SPR.hkbirdcages = SPR.desk;
  SPR.hkredanchorsign = SPR.desk;
  SPR.hkstreetpost = SPR.desk;
  SPR.hkstopsign = SPR.desk;
  SPR.hkhsbcsign = SPR.desk;
  SPR.hkqueensroadsign = SPR.desk;
  SPR.hkrickshaw = SPR.desk;
  SPR.hkricemerchantsign = SPR.desk;
  SPR.hkferry = SPR.desk;
  SPR.hkdragondensign = SPR.desk;
  SPR.hknightmarketsign = SPR.desk;
  SPR.hkphonesign = SPR.desk;
  SPR.tehranstreetsign1 = SPR.desk;
  SPR.tehranshadowposter = SPR.desk;
  SPR.tehranganjeposter = SPR.desk;
  SPR.tehranbooksign1 = SPR.desk;
  SPR.tehrancafesign = SPR.desk;
  SPR.tehranteaposter = SPR.desk;
  SPR.tehranstreetsign2 = SPR.desk;
  SPR.tehrancinemasign = SPR.desk;
  SPR.tehranbooksign2 = SPR.desk;
  SPR.tehranstreetsign3 = SPR.desk;
  ...
  const ART_ASSETS = {                                      // bump a path's ?v= whenever that file on disk changes
    ...
    parisoperabust1: 'assets/sprites/parisoperabust1.png?v=1',
    parisoperabust2: 'assets/sprites/parisoperabust2.png?v=1',
    parisoperamusicstand: 'assets/sprites/parisoperamusicstand.png?v=1',
    parisoperadrape: 'assets/sprites/parisoperadrape.png?v=1',
    parisoperaapollo: 'assets/sprites/parisoperaapollo.png?v=1',
    parisoperachair: 'assets/sprites/parisoperachair.png?v=1',
    parisoperaharp: 'assets/sprites/parisoperaharp.png?v=1',
    parisoperaceiling: 'assets/sprites/parisoperaceiling.png?v=1',
    parisoperasign: 'assets/sprites/parisoperasign.png?v=1',
    parisoperarigging: 'assets/sprites/parisoperarigging.png?v=1',
    parisoperaprogramstand: 'assets/sprites/parisoperaprogramstand.png?v=1',
    parisoperastatuegroup: 'assets/sprites/parisoperastatuegroup.png?v=1',
    parisoperatapestry: 'assets/sprites/parisoperatapestry.png?v=1',
    parisoperamannequin: 'assets/sprites/parisoperamannequin.png?v=1',
    parisoperasconce: 'assets/sprites/parisoperasconce.png?v=1',
    parisoperafan: 'assets/sprites/parisoperafan.png?v=1',
    parisoperadoor: 'assets/sprites/parisoperadoor.png?v=1',
    parisoperaclock: 'assets/sprites/parisoperaclock.png?v=1',
    parisoperascorestand: 'assets/sprites/parisoperascorestand.png?v=1',
    parisoperapanel: 'assets/sprites/parisoperapanel.png?v=1',
    parisoperatrunk: 'assets/sprites/parisoperatrunk.png?v=1',
    parisoperaseatrow: 'assets/sprites/parisoperaseatrow.png?v=1',
    metroentrance: 'assets/sprites/metroentrance.png?v=2',
    boulevardlamp: 'assets/sprites/boulevardlamp.png?v=1',
    stdkey: 'assets/sprites/stdkey.png?v=1',
    personnelfile: 'assets/sprites/personnelfile.png?v=1',
    ...
    letter: 'assets/sprites/letter.png?v=1',
    ...
    kremlin: 'assets/sprites/kremlin.png?v=1',
    leninstatue: 'assets/sprites/leninstatue.png?v=1',
    stbasils: 'assets/sprites/stbasils.png?v=1',
    bolshoitheatre: 'assets/sprites/bolshoitheatre.png?v=1',
    kgbheadquarters: 'assets/sprites/kgbheadquarters.png?v=1',
    ...
    bomb: 'assets/sprites/bomb.png?v=2',
    bombOpen: 'assets/sprites/bombOpen.png?v=2',
    bombRedCut: 'assets/sprites/bombRedCut.png?v=2',
    bombBlueCut: 'assets/sprites/bombBlueCut.png?v=2',
    desk: 'assets/sprites/desk.png?v=2',
    deskOpen: 'assets/sprites/deskOpen.png?v=2',
    safe: 'assets/sprites/safe.png?v=2',
    safeOpen: 'assets/sprites/safeOpen.png?v=2',
    ...
    oaktree: 'assets/sprites/oaktree.png?v=2',
    pinetree: 'assets/sprites/pinetree.png?v=2',
    mapletree: 'assets/sprites/mapletree.png?v=2',
    birchtree: 'assets/sprites/birchtree.png?v=2',
    ...
    bbqgrill: 'assets/sprites/bbqgrill.png?v=1',
    lawnmower: 'assets/sprites/lawnmower.png?v=1',
    sprinkler: 'assets/sprites/sprinkler.png?v=1',
    swingset: 'assets/sprites/swingset.png?v=1',
    picnictable: 'assets/sprites/picnictable.png?v=1',
    ...
    havanarumbillboard: 'assets/sprites/havanarumbillboard.png?v=1',
    havanafloriditasign: 'assets/sprites/havanafloriditasign.png?v=1',
    havanateatrosign: 'assets/sprites/havanateatrosign.png?v=1',
    havanaaviacionposter: 'assets/sprites/havanaaviacionposter.png?v=1',
    havanaministeriosign: 'assets/sprites/havanaministeriosign.png?v=1',
    havanacafemenu: 'assets/sprites/havanacafemenu.png?v=1',
    havanastreetpost: 'assets/sprites/havanastreetpost.png?v=1',
    havanacafeteriasign: 'assets/sprites/havanacafeteriasign.png?v=1',
    havanaazucarbillboard: 'assets/sprites/havanaazucarbillboard.png?v=1',
    havanaphonesign: 'assets/sprites/havanaphonesign.png?v=1',
    nycbillboard: 'assets/sprites/nycbillboard.png?v=1',
    nycjazzsign: 'assets/sprites/nycjazzsign.png?v=1',
    nyccabaretsign: 'assets/sprites/nyccabaretsign.png?v=1',
    nycpanamposter: 'assets/sprites/nycpanamposter.png?v=1',
    nycsubwaysign: 'assets/sprites/nycsubwaysign.png?v=1',
    nyccafesign: 'assets/sprites/nyccafesign.png?v=1',
    nycstreetpost: 'assets/sprites/nycstreetpost.png?v=1',
    nycelectronicssign: 'assets/sprites/nycelectronicssign.png?v=1',
    nycmoscowbillboard: 'assets/sprites/nycmoscowbillboard.png?v=1',
    nycpostsign: 'assets/sprites/nycpostsign.png?v=1',
    nycphonesign: 'assets/sprites/nycphonesign.png?v=1',
    ...
    parisposter3: 'assets/sprites/parisposter3.png?v=1',
    parisodeonsign: 'assets/sprites/parisodeonsign.png?v=1',
    parislibrairiesign: 'assets/sprites/parislibrairiesign.png?v=1',
    parisstreetcorner: 'assets/sprites/parisstreetcorner.png?v=1',
    parisboulangeriesign1: 'assets/sprites/parisboulangeriesign1.png?v=1',
    parisboulangeriesign2: 'assets/sprites/parisboulangeriesign2.png?v=1',
    parisbusstopsign: 'assets/sprites/parisbusstopsign.png?v=1',
    hkcatheaybillboard: 'assets/sprites/hkcatheaybillboard.png?v=1',
    hkpagodabillboard: 'assets/sprites/hkpagodabillboard.png?v=1',
    hktheatresign: 'assets/sprites/hktheatresign.png?v=1',
    hkjockeyclubsign: 'assets/sprites/hkjockeyclubsign.png?v=1',
    hkromanceposter: 'assets/sprites/hkromanceposter.png?v=1',
    hkshaolinposter: 'assets/sprites/hkshaolinposter.png?v=1',
    hkbirdcages: 'assets/sprites/hkbirdcages.png?v=1',
    hkredanchorsign: 'assets/sprites/hkredanchorsign.png?v=1',
    hkstreetpost: 'assets/sprites/hkstreetpost.png?v=1',
    hkstopsign: 'assets/sprites/hkstopsign.png?v=1',
    hkhsbcsign: 'assets/sprites/hkhsbcsign.png?v=1',
    hkqueensroadsign: 'assets/sprites/hkqueensroadsign.png?v=1',
    hkrickshaw: 'assets/sprites/hkrickshaw.png?v=1',
    hkricemerchantsign: 'assets/sprites/hkricemerchantsign.png?v=1',
    hkferry: 'assets/sprites/hkferry.png?v=1',
    hkdragondensign: 'assets/sprites/hkdragondensign.png?v=1',
    hknightmarketsign: 'assets/sprites/hknightmarketsign.png?v=1',
    hkphonesign: 'assets/sprites/hkphonesign.png?v=1',
    tehranstreetsign1: 'assets/sprites/tehranstreetsign1.png?v=1',
    tehranshadowposter: 'assets/sprites/tehranshadowposter.png?v=1',
    tehranganjeposter: 'assets/sprites/tehranganjeposter.png?v=1',
    tehranbooksign1: 'assets/sprites/tehranbooksign1.png?v=1',
    tehrancafesign: 'assets/sprites/tehrancafesign.png?v=1',
    tehranteaposter: 'assets/sprites/tehranteaposter.png?v=1',
    tehranstreetsign2: 'assets/sprites/tehranstreetsign2.png?v=1',
    tehrancinemasign: 'assets/sprites/tehrancinemasign.png?v=1',
    tehranbooksign2: 'assets/sprites/tehranbooksign2.png?v=1',
    tehranstreetsign3: 'assets/sprites/tehranstreetsign3.png?v=1',
    ...
    decalCosmosPoster: 'assets/sprites/decalCosmosPoster.png?v=1',
    decalFactoryPoster: 'assets/sprites/decalFactoryPoster.png?v=1',
    decalRedSquareSign: 'assets/sprites/decalRedSquareSign.png?v=1',
    decalGroceryPoster: 'assets/sprites/decalGroceryPoster.png?v=1',
    decalTramStopSign: 'assets/sprites/decalTramStopSign.png?v=1',
    decalCinemaPoster: 'assets/sprites/decalCinemaPoster.png?v=1',
    decalCautionSign: 'assets/sprites/decalCautionSign.png?v=1',
    decalBankPlaque: 'assets/sprites/decalBankPlaque.png?v=1',
    decalMetroSign: 'assets/sprites/decalMetroSign.png?v=1',
  ...
  const FACT = {
    ...
    kremlin: (x, y) => prop('kremlin', 'THE KREMLIN', x, y, 2.4, true),
    stbasils: (x, y) => prop('stbasils', "ST. BASIL'S CATHEDRAL", x, y, 1.8, true),
    bolshoitheatre: (x, y) => prop('bolshoitheatre', 'BOLSHOI THEATRE', x, y, 1.8, true),
    kgbheadquarters: (x, y) => prop('kgbheadquarters', 'KGB HEADQUARTERS', x, y, 2.2, true),
    leninstatue: (x, y) => prop('leninstatue', 'LENIN STATUE', x, y, 1.0, true),
    ...
    // City signage/billboard props, cropped from regional prop sheets
    havanarumbillboard: (x, y) => prop('havanarumbillboard', 'HAVANA CLUB RUM BILLBOARD', x, y, 1.4, false),
    havanafloriditasign: (x, y) => prop('havanafloriditasign', 'EL FLORIDITA', x, y, 0.55, false),
    havanateatrosign: (x, y) => prop('havanateatrosign', 'TEATRO PAYRET', x, y, 0.55, false),
    havanaaviacionposter: (x, y) => prop('havanaaviacionposter', 'CUBANA DE AVIACION POSTER', x, y, 0.85, false),
    havanaministeriosign: (x, y) => prop('havanaministeriosign', 'MINISTERIO DEL INTERIOR', x, y, 0.5, false),
    havanacafemenu: (x, y) => prop('havanacafemenu', 'CAFE DE LA HABANA MENU', x, y, 0.6, false),
    havanastreetpost: (x, y) => prop('havanastreetpost', 'CALLE OBISPO STREET POST', x, y, 1.1, false),
    havanacafeteriasign: (x, y) => prop('havanacafeteriasign', 'CAFETERIA LA BODEGUITA', x, y, 0.55, false),
    havanaazucarbillboard: (x, y) => prop('havanaazucarbillboard', 'OPERACION AZUCAR BILLBOARD', x, y, 1.4, false),
    havanaphonesign: (x, y) => prop('havanaphonesign', 'TELEPHONE SIGN', x, y, 0.65, false),
    nycbillboard: (x, y) => prop('nycbillboard', 'SILVERSTREAK CIGARETTES BILLBOARD', x, y, 1.4, false),
    nycjazzsign: (x, y) => prop('nycjazzsign', 'THE BLUE NOTE JAZZ CLUB', x, y, 0.55, false),
    nyccabaretsign: (x, y) => prop('nyccabaretsign', 'BROADWAY CABARET', x, y, 0.5, false),
    nycpanamposter: (x, y) => prop('nycpanamposter', 'PAN AM POSTER', x, y, 0.85, false),
    nycsubwaysign: (x, y) => prop('nycsubwaysign', 'N.Y.C. SUBWAY SIGN', x, y, 0.5, false),
    nyccafesign: (x, y) => prop('nyccafesign', "JOE'S ALL-NIGHT CAFE", x, y, 0.55, false),
    nycstreetpost: (x, y) => prop('nycstreetpost', '5TH AVE STREET POST', x, y, 1.1, false),
    nycelectronicssign: (x, y) => prop('nycelectronicssign', 'MODERN ELECTRONICS SIGN', x, y, 0.5, false),
    nycmoscowbillboard: (x, y) => prop('nycmoscowbillboard', 'THE MAN FROM MOSCOW BILLBOARD', x, y, 1.4, false),
    nycpostsign: (x, y) => prop('nycpostsign', 'NEW YORK POST SIGN', x, y, 0.4, false),
    nycphonesign: (x, y) => prop('nycphonesign', 'TELEPHONE SIGN', x, y, 0.65, false),
    ...
    parisposter3: (x, y) => prop('parisposter3', 'VINS NICOLAS POSTER', x, y, 0.85, false),
    parisodeonsign: (x, y) => prop('parisodeonsign', 'STATION ODEON SIGN', x, y, 0.6, false),
    parislibrairiesign: (x, y) => prop('parislibrairiesign', 'LIBRAIRIE ANCIENNE', x, y, 0.5, false),
    parisstreetcorner: (x, y) => prop('parisstreetcorner', 'RUE + INTERDIT STATIONNER CORNER', x, y, 1.0, false),
    parisboulangeriesign1: (x, y) => prop('parisboulangeriesign1', 'BOULANGERIE LE BON PAIN (DARK)', x, y, 0.5, false),
    parisboulangeriesign2: (x, y) => prop('parisboulangeriesign2', 'BOULANGERIE LE BON PAIN (LIGHT)', x, y, 0.5, false),
    parisbusstopsign: (x, y) => prop('parisbusstopsign', 'ARRET BUS SIGN', x, y, 0.65, false),
    hkcatheaybillboard: (x, y) => prop('hkcatheaybillboard', 'FLY CATHEAY PACIFIC BILLBOARD', x, y, 1.4, false),
    hkpagodabillboard: (x, y) => prop('hkpagodabillboard', 'GOLDEN PAGODA BEER BILLBOARD', x, y, 1.2, false),
    hktheatresign: (x, y) => prop('hktheatresign', 'WORLD THEATRE SIGN', x, y, 0.7, false),
    hkjockeyclubsign: (x, y) => prop('hkjockeyclubsign', 'HONG KONG JOCKEY CLUB SIGN', x, y, 0.5, false),
    hkromanceposter: (x, y) => prop('hkromanceposter', 'A CLASSIC ROMANCE POSTER', x, y, 0.85, false),
    hkshaolinposter: (x, y) => prop('hkshaolinposter', 'SHAOLIN TEMPLE ART EXHIBIT POSTER', x, y, 0.85, false),
    hkbirdcages: (x, y) => prop('hkbirdcages', 'HANGING BIRD CAGES', x, y, 0.5, false),
    hkredanchorsign: (x, y) => prop('hkredanchorsign', 'RED ANCHOR CIGARETTES SIGN', x, y, 0.5, false),
    hkstreetpost: (x, y) => prop('hkstreetpost', 'NATHAN RD STREET POST', x, y, 1.1, false),
    hkstopsign: (x, y) => prop('hkstopsign', 'STOP SIGN', x, y, 0.65, false),
    hkhsbcsign: (x, y) => prop('hkhsbcsign', 'HSBC HONG KONG BRANCH SIGN', x, y, 0.45, false),
    hkqueensroadsign: (x, y) => prop('hkqueensroadsign', "QUEEN'S ROAD CENTRAL SIGN", x, y, 0.4, false),
    hkrickshaw: (x, y) => prop('hkrickshaw', 'RICKSHAW', x, y, 0.6, false),
    hkricemerchantsign: (x, y) => prop('hkricemerchantsign', 'RICE MERCHANT SIGN', x, y, 0.7, false),
    hkferry: (x, y) => prop('hkferry', 'STAR FERRY', x, y, 1.6, false),
    hkdragondensign: (x, y) => prop('hkdragondensign', 'DRAGON DEN BAR & NIGHTCLUB SIGN', x, y, 0.6, false),
    hknightmarketsign: (x, y) => prop('hknightmarketsign', 'NIGHT MARKET SIGN', x, y, 0.9, false),
    hkphonesign: (x, y) => prop('hkphonesign', 'TELEPHONE SIGN', x, y, 0.65, false),
    tehranstreetsign1: (x, y) => prop('tehranstreetsign1', 'KHIYABAN PAHLAVI SIGN', x, y, 0.55, false),
    tehranshadowposter: (x, y) => prop('tehranshadowposter', 'OPERATION SHADOW POSTER', x, y, 0.85, false),
    tehranganjeposter: (x, y) => prop('tehranganjeposter', 'GANJ-E QAROON POSTER', x, y, 0.85, false),
    tehranbooksign1: (x, y) => prop('tehranbooksign1', 'KITABFOROOSHI SIGN (1)', x, y, 0.5, false),
    tehrancafesign: (x, y) => prop('tehrancafesign', 'CAFE NADERI SIGN', x, y, 0.55, false),
    tehranteaposter: (x, y) => prop('tehranteaposter', 'CHAI POSTER', x, y, 0.85, false),
    tehranstreetsign2: (x, y) => prop('tehranstreetsign2', 'MEYDAN-E AZADI SIGN (1)', x, y, 0.5, false),
    tehrancinemasign: (x, y) => prop('tehrancinemasign', 'CINEMA MOULIN ROUGE SIGN', x, y, 0.55, false),
    tehranbooksign2: (x, y) => prop('tehranbooksign2', 'KITABFOROOSHI SIGN (2)', x, y, 0.5, false),
    tehranstreetsign3: (x, y) => prop('tehranstreetsign3', 'MEYDAN-E AZADI SIGN (2)', x, y, 0.5, false),
    ...
    decalCosmosPoster: (x, y) => prop('decalCosmosPoster', 'COSMOS POSTER', x, y, 0.9, false),
    decalFactoryPoster: (x, y) => prop('decalFactoryPoster', 'FACTORY POSTER', x, y, 0.7, false),
    decalRedSquareSign: (x, y) => prop('decalRedSquareSign', 'RED SQUARE SIGN', x, y, 0.7, false),
    decalGroceryPoster: (x, y) => prop('decalGroceryPoster', 'GROCERY SIGN', x, y, 0.8, false),
    decalTramStopSign: (x, y) => prop('decalTramStopSign', 'TRAM STOP SIGN', x, y, 0.7, false),
    decalCinemaPoster: (x, y) => prop('decalCinemaPoster', 'CINEMA POSTER', x, y, 0.9, false),
    decalCautionSign: (x, y) => prop('decalCautionSign', 'CAUTION SIGN', x, y, 0.6, false),
    decalBankPlaque: (x, y) => prop('decalBankPlaque', 'BANK PLAQUE', x, y, 0.7, false),
    decalMetroSign: (x, y) => prop('decalMetroSign', 'METRO SIGN', x, y, 1.0, false),
    ...
    parisoperabust1: (x, y) => prop('parisoperabust1', 'MARBLE BUST', x, y, 0.75, true),
    parisoperabust2: (x, y) => prop('parisoperabust2', 'MARBLE BUST', x, y, 0.75, true),
    parisoperamusicstand: (x, y) => prop('parisoperamusicstand', 'MUSIC STAND', x, y, 0.85, true),
    parisoperadrape: (x, y) => prop('parisoperadrape', 'DRAPED MARBLE', x, y, 0.75, true),
    parisoperaapollo: (x, y) => prop('parisoperaapollo', 'STATUE OF APOLLO', x, y, 1.1, true),
    parisoperachair: (x, y) => prop('parisoperachair', 'VELVET ARMCHAIR', x, y, 0.85, true),
    parisoperaharp: (x, y) => prop('parisoperaharp', 'GILDED HARP', x, y, 0.95, true),
    parisoperaceiling: (x, y) => prop('parisoperaceiling', 'CEILING FRESCO', x, y, 1.3, false),
    parisoperasign: (x, y) => prop('parisoperasign', 'LOGE 1 ORCHESTRE SIGN', x, y, 0.55, false),
    parisoperarigging: (x, y) => prop('parisoperarigging', 'FLY RIGGING', x, y, 1.2, true),
    parisoperaprogramstand: (x, y) => prop('parisoperaprogramstand', 'PROGRAM STAND', x, y, 0.85, true),
    parisoperastatuegroup: (x, y) => prop('parisoperastatuegroup', 'ALLEGORICAL STATUE', x, y, 1.3, true),
    parisoperatapestry: (x, y) => prop('parisoperatapestry', 'GARDEN TAPESTRY', x, y, 1.3, false),
    parisoperamannequin: (x, y) => prop('parisoperamannequin', 'DRESS FORM', x, y, 0.85, true),
    parisoperasconce: (x, y) => prop('parisoperasconce', 'CANDLE SCONCE', x, y, 0.55, false),
    parisoperafan: (x, y) => prop('parisoperafan', 'PAINTED FAN', x, y, 0.5, false),
    parisoperadoor: (x, y) => prop('parisoperadoor', 'LOGE DOOR', x, y, 1.0, true),
    parisoperaclock: (x, y) => prop('parisoperaclock', 'MANTEL CLOCK', x, y, 0.55, false),
    parisoperascorestand: (x, y) => prop('parisoperascorestand', 'SHEET MUSIC STAND', x, y, 0.85, true),
    parisoperapanel: (x, y) => prop('parisoperapanel', 'GILDED INSTRUMENT PANEL', x, y, 1.2, false),
    parisoperatrunk: (x, y) => prop('parisoperatrunk', 'STAGE TRUNK', x, y, 0.7, true),
    parisoperaseatrow: (x, y) => prop('parisoperaseatrow', 'THEATER SEAT ROW', x, y, 1.5, true),
